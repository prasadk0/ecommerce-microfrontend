...
export const PRODUCTS_CONSTANTS = {
  ...
  FILTERS: {
    ...
    PRICE: {
      ...
      RANGES: {
        ZERO_TO_THOUSAND: '₹0 - ₹1,000',
        THOUSAND_TO_FIVE_THOUSAND: '₹1,000 - ₹5,000',
  ...
  TABLE: {
    ...
    ORDERS: [

      {
        ...
        customerEmail: 'rahul.sharma@mail.com',
...

      {
        ...
        customerEmail: 'priya.nair@mail.com',
        product: 'Smart Watch',
        itemsCount: 1,
        amount: 4999,
        date: '2026-08-24',
...

      {
        ...
        customerEmail: 'amit.verma@mail.com',
...

      {
        ...
        customerEmail: 'sneha.iyer@mail.com',
...

      {
        ...
        customerEmail: 'karan.mehta@mail.com',
        product: 'Wireless Headphones',
        itemsCount: 1,
        amount: 2499,
        date: '2026-08-22',
...

      {
        ...
        customerEmail: 'divya.rao@mail.com',
        product: 'Smart Watch',
        itemsCount: 1,
        amount: 4999,
        date: '2026-08-22',
...

      {
        ...
        customerEmail: 'arjun.singh@mail.com',
        product: 'Laptop Stand',
        itemsCount: 1,
        amount: 1799,
        date: '2026-08-21',
...

      {
        ...
        customerEmail: 'neha.gupta@mail.com',
        product: 'Bluetooth Speaker',
        itemsCount: 3,
        amount: 5697,
        date: '2026-08-21',
  ...
  TRACKING: {
    ...
    TIMELINE: {
      ...
      OUT_FOR_DELIVERY: {
        ...
        DESCRIPTION:
          'Your package is on the way to your delivery address.'
...
export const NOTIFICATIONS_CONSTANTS = {
  ...
  PAGE_HEADER: {
    ...
    DESCRIPTION:
      'Stay updated with your latest store activities.',
