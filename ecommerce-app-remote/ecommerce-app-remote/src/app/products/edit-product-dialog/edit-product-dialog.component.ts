...
export class EditProductDialogComponent implements OnChanges {
  ...
  private patchProduct(): void {
    ...
    this.productForm.patchValue({
      ...
      price: this.getNumberValue(this.product.price),
      stock: this.getNumberValue(this.product.stock),
  ...
  saveProduct(): void {
    ...
    const updatedProduct = {
      ...formValue,
      price: this.getNumberValue(formValue.price),
      stock: this.getNumberValue(formValue.stock)
    };
